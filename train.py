...
# dump them in pickle file
# https://pythonnumericalmethods.berkeley.edu/notebooks/chapter11.03-Pickle-Files.html#:~:text=Pickle%20can%20be%20used%20to,back%20to%20a%20Python%20object.
...
model.add(Dropout(0.5))
model.add(Dense(len(train_y[0]), activation="softmax")) #contains the number of neurons equal to the number of intents
model.summary()
...
model.save("chatbot_model.h5", hist)  # fast access from the Flask REST API without the need of retraining.
print("model created")
